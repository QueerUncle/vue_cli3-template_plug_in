...
UE.I18N['en'] = {
    ...
    'insertvideo':{
        ...
        'urlError':"The CbimPlayer url format may be wrong!",
        'loading':" &nbsp;The CbimPlayer is loading, please wait…",
        'clickToSelect':"Click to select",
        'goToSource':'Visit source CbimPlayer ',
        'noVideo':" &nbsp; &nbsp;Sorry,can't find the CbimPlayer,please try again!",
